...
def parse_source(reader):
    ...
    resp.服务器名称 = reader.read_cstring()
    resp.地图 = reader.read_cstring()
    #resp.folder = reader.read_cstring()
    resp.游戏 = reader.read_cstring()
    #resp.app_id = reader.read_uint16()
    resp.当前游玩人数 = reader.read_uint8()
    resp.服务器人数 = reader.read_uint8()
    resp.人机人数 = reader.read_uint8()
